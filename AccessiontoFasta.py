...
def FastatoAlignmentFinder(Protein):
    ...
    os.system('module load gcc/9.2.0')
    os.system('module load muscle/3.8.31')
    os.system('muscle -in ' + Protein+'onSARS2.fasta -clw -out /sfs/lustre/bahamut/scratch/jws6pq/Notebook/Alignment/'+ Protein+'onSARS2.aln')

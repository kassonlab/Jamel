...
file =open(glob.glob("*onMERS.aln")[0],"r")
file3 =open(glob.glob("*onSARS.aln")[0],"r")
MERSAlignment=file.readlines()
SARS2Alignment=file2.readlines()
SARSAlignment=file3.readlines()
GrishinAlginment=np.empty((5,3), dtype=object)
GrishinAlginment2=np.empty((5,3), dtype=object)
GrishinAlginment3=np.empty((5,3), dtype=object)
Targetsequence=file.name.replace('onMERS.aln','')
Targetsequence2=file2.name.replace('onSARS2.aln','')
Targetsequence3=file3.name.replace('onSARS.aln','')
Templatesequence='MERS_INPUT'
Templatesequence2='SARS2_INPUT'
Templatesequence3='SARS_INPUT'
...
GrishinAlginment3[0,0]='##'
GrishinAlginment3[0,1]=Targetsequence3
GrishinAlginment3[0,2]=Templatesequence3+'.pdb'
GrishinAlginment3[1,0]='#'
GrishinAlginment3[2,0]='scores from program : 0'
GrishinAlginment3[3,0]='0'
GrishinAlginment3[4,0]='0'
GrishinAlginment3[3,1]=''
GrishinAlginment3[4,1]=''
GrishinAlginment3[1,1]=''
GrishinAlginment3[1,2]=''
GrishinAlginment3[2,1]=''
GrishinAlginment3[2,2]=''
GrishinAlginment3[3,2]=''
GrishinAlginment3[4,2]=''
i=0
#4 lines separate the sequences in the clustalw alignment

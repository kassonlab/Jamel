...
#
# # access the arguments using their flag names
#
...
if prime_container.operation_toggles['run_analysis_operation?'] == '#':
    ...
    reference_stem = Path(container.fasta_arguments["reference_submission"]).stem
    partner_stem = Path(container.fasta_arguments["partner_submission"]).stem

...
if __name__ == '__main__':
    # TODO check that the right type of json was entered
    # TODO I could amke this submission scirpt the same for all chimeraclass so I dont have to keep remaking args and scripts
    TOTAL_ARGS = ChimeraClasses.NonHomologyChimeraArgs(args.arg_jsons)

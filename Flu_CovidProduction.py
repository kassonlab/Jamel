...
SequenceList1=[x[0] for x in list(map(ChimeraGenerator.SequenceSplice,Protein1,Boundary1,Boundary2))]
...
SequenceList2=[x[0] for x in list(map(ChimeraGenerator.SequenceSplice,Protein2,Boundary3,Boundary4))]

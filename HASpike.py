...
SequenceList1=list(map(ChimeraGenerator.SequenceSplice,Protein1,Boundary1,Boundary2))
SpliceLength1=200
...
SequenceList2=list(map(ChimeraGenerator.SequenceSplice,Protein2,Boundary3,Boundary4))
Slurmfilenumber=1
